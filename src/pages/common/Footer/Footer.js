        ...
        <footer className="footer footer-center p-10 bg-primary text-primary-content">
            <div>
                ...
                <p className="font-bold">
                    City Bike Oy <br />Since 1992
                </p>
                <p>Copyright © 2023 - All right reserved</p>
            </div>
            <div>
                <div className="grid grid-flow-col gap-4">
                    <a href='https://www.facebook.com/'> <FiFacebook className='text-xl'></FiFacebook> </a>
                    <a href='https://twitter.com/'> <FiTwitter className='text-xl'></FiTwitter> </a>
                    <a href='https://youtube.com/'> <FiYoutube className='text-xl'></FiYoutube> </a>
                </div>
            </div>
        </footer>
    );
